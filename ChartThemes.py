...
class createBar_all(QWidget):
    def __init__(self, parent=None):
        super(createBar_all, self).__init__(parent)
        self.setAttribute(Qt.WA_TranslucentBackground)
        self.setWindowFlags(Qt.FramelessWindowHint)
        self.ui = ThemeWidget()
        self.m_charts=[]
        ...
        self.chartView = QChartView(self.ui.createAreaChart(self.m_dataTable))
        self.chartView.setStyleSheet("background: transparent; border: none;")  # 设置无边框和透明背景
        baseLayout.addWidget(self.chartView, 1, 1)
        self.m_charts.append(self.chartView)

        self.chartView = QChartView(self.ui.createLineChart(self.m_dataTable))
        self.chartView.setStyleSheet("background: transparent; border: none;")  # 设置无边框和透明背景
        baseLayout.addWidget(self.chartView, 1, 2)
        self.m_charts.append(self.chartView)

        self.chartView = QChartView(self.ui.createPieChart(self.m_dataTable))
        self.chartView.setStyleSheet("background: transparent; border: none;")  # 设置无边框和透明背景
        baseLayout.addWidget(self.chartView, 2, 0)
        self.m_charts.append(self.chartView)

        self.chartView = QChartView(self.ui.createSplineChart(self.m_dataTable))
        self.chartView.setStyleSheet("background: transparent; border: none;")  # 设置无边框和透明背景
        baseLayout.addWidget(self.chartView, 2, 1)
        self.m_charts.append(self.chartView)

        self.chartView = QChartView(self.ui.createScatterChart(self.m_dataTable))
        self.chartView.setStyleSheet("background: transparent; border: none;")  # 设置无边框和透明背景
        baseLayout.addWidget(self.chartView, 2, 2)
        self.m_charts.append(self.chartView)
